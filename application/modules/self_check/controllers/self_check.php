...
class Self_check extends MX_Controller
{
	public function __construct()
	{
        ...
        if(ENVIRONMENT!=='development' || $_SERVER['REMOTE_ADDR']=='192.168.0.1')
        {
	...
	public function self_check()
	{
		...
		$data['mid_sec'] = $this->load->view('self_check/verify_view', $data, TRUE);
		$this->load->view('jaz_auth_admin/adminpanel', $data);				
	}
}
/* End of file 'Verify' */
